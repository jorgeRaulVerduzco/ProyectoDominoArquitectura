...
public class FachadaServicioPozo {
     ...
     *
     * @param jugadoresDTO Lista de jugadores DTO.
     */
    public void iniciarNuevoJuego(List<JugadorDTO> jugadoresDTO) {
     ...
     */
    public FichaDTO tomarFichaDelPozo(int indice) {
        Ficha ficha = servicioPozo.tomarFichaDelPozo(servicioPozo.getPozo(), indice);
        if (ficha != null) {
            return convertirEntidadADTO(ficha);
        }
        return null;
    }
     ...
     *
     * @param fichaDTO Ficha DTO que se desea eliminar del pozo.
     * @return true si la ficha fue eliminada exitosamente, false si no se
     * encontró.
     */
    public boolean eliminarFichaDelPozo(FichaDTO fichaDTO) {
     ...
     */
    public PozoDTO obtenerEstadoPozo() {
        Pozo pozo = servicioPozo.getPozo();
        return convertirEntidadADTO(pozo);
    }
