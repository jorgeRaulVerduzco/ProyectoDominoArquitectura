...
public class PozoController {
    ...
    // Toma una ficha del pozo y actualiza la vista
     public void tomarFichaDelPozo(int indice) {
        ...
        if (fichaTomada != null) {
            // Lógica adicional: agregar ficha a la mano del jugador actual
            // Puedes tener un objeto jugadorActual en tu controlador que maneje la ficha
            // jugadorActual.agregarFicha(fichaTomada);
